...
class PancakeHouseCollectionTests: XCTestCase {
    ...
    func testSetFavoritePancakeHouse() {
    ...
    func testWhenTryToRemoveUnknownFavoriteThrowsExpectedError() {
        ...
        // then
        XCTAssertThrowsError(try collection.removePancakeHouse(pancakeHouse), "Should not be allowed to remove unknowkn pancake house") {
            let error = $0 as! PancakseHouseError
